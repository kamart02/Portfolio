 ...
 *
 * Wyznacza następujący ciąg numerów: jeżeli prefiks @p num jest przekierowaniem
 * to napis, którego początek jest numerem przekierwanym na prefiks, a koniec
 * resztą (sufiksem) @p num. Dodatkowo ciąg wynikowy zawsze zawiera też numer
 * @p num. Wynikowe numery są posortowane leksykograficznie i nie mogą się
...
/**
 * @brief Przeciwobraz funkcji @p phfwdGet
 * Tworzy przeciwobraz funkcji @p phfwdGet. Jeżeli napis nie reprezentuje
 * numeru zwraca pustą strukturę.
 * @param [in] pf - wskaźnik na drzewo przekierowań.
 * @param [in] num - wskaźnik na numer.
 * @return Wskaźnik na strukturę phnum zawierająca przeciwobraz funkcji
 *         @p phfwdGet
 */
